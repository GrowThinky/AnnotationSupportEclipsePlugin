...
public abstract class MyJavaEditor extends AbstractDecoratedTextEditor implements IViewPartInputProvider {
	...
	private class EditorSelectionChangedListener extends AbstractSelectionChangedListener {
		...
		public void selectionChanged(SelectionChangedEvent event) {
			...
			MyJavaEditor.this.selectionChanged();
		}
	}
	...
	private final class ToggleFoldingRunner implements IPartListener2 {
		...
		public void runWhenNextVisible() {
			...
			if (site != null) {
				...
				if (!page.isPartVisible(MyJavaEditor.this)) {
		...
		public void partVisible(IWorkbenchPartReference partRef) {
			if (MyJavaEditor.this.equals(partRef.getPart(false))) {
				cancel();
				toggleFolding();
			}
		}
